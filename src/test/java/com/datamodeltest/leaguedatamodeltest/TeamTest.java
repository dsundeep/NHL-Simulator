...
public class TeamTest {
	...
	public void getTeamIdTest() {
		team.setTeamId(10);
		Assert.assertEquals(10, team.getTeamId());
	}

	@Test
	public void setTeamIdTest() {
		Assert.assertTrue(team.setTeamId(10));
	}
	...
	public void getPlayersCountTest() {
		...
		ITeam team = leagueMock.getLeague().getAllTeams().get(0);
		Assert.assertEquals(team.getPlayers().size(), team.getPlayersCount());
	}

	@Test
	public void getPlayingGoaliesCount() {
		GamePlayConfigAbstractFactory.setFactory(new GamePlayConfigFactory());
		LeagueDataModelAbstractFactory.setFactory(new LeagueDataModelFactoryTest());
		LeagueMock leagueMock = new LeagueMock();
		ITeam team = leagueMock.getLeague().getAllTeams().get(0);
		Assert.assertEquals(4, team.getPlayingGoaliesCount());
	}

	@Test
	public void getPlayingSkatersCount() {
		GamePlayConfigAbstractFactory.setFactory(new GamePlayConfigFactory());
		LeagueDataModelAbstractFactory.setFactory(new LeagueDataModelFactoryTest());
		LeagueMock leagueMock = new LeagueMock();
		ITeam team = leagueMock.getLeague().getAllTeams().get(0);
		Assert.assertEquals(26, team.getPlayingSkatersCount());
	}
